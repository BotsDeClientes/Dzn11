 ...
 *┃➤* _${usedPrefix}Proveedor / Deseas Vender Linda ?_
 *┃➤* _${usedPrefix}LindaComu / Publicidad De La Comunidad Linda_
 ...
 *┃➤* _${usedPrefix}Tarjetas_
  ╰━━━━━━━━━━━━━
   ...
   ╭━〔 *🌸 Linda Pornero 🌸* 〕
 *┃➤* _${usedPrefix}LindaPajero_
 *┃➤* _${usedPrefix}LindaPornero_
  ╰━━━━━━━━━━━━━
 ...
 *┃➤* _${usedPrefix}minarLindacoins | minarcoins_
 ...
 *┃➤* _${usedPrefix}darLindacoins *cantidad*_
 ...
 *┃➤* _${usedPrefix}delLindacoins *@tag*_
 ...
 *┃➤* _${usedPrefix}añadirLindacoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝗕𝗼𝘁 𝗗𝗲 𝗟𝗶𝗻𝗱𝗮 🌸', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
